...
# Cargamos datos 
nombre_completo_madre = str(input('ingrese el nombre completo de la madre: '))
nombre_completo_padre = str(input('Ingrese el nombre completo del padre: '))
nombre_hijo  = str(input('Ingrese SOLO nombre del Hijo: '))
...
print(f'El apellido y nombre del hijo es: {apellido_padre} {apellido_madre}, {nombre_hijo} ')